...
import { TodoType } from "@/app/todolist/TodoType";
...
async function writeData(data: TodoType[]) {
...
export async function GET(req: NextRequest) {
    ...
    if (id) {
        ...
        if (todo) {
            ...
            return NextResponse.json({ message: `${id}에 해당하는 할 일을 찾을 수 없습니다.` }, { status: 404 });
        }
    } else {
